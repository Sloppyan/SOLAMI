...
face_config = "demos/VRRelay/datasets/face_config.json"
motion_config = "demos/VRRelay/datasets/motion_config.json"
main_config = read_json_file("demos/VRRelay/config.json")
