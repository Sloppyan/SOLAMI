...
def getCheckpointCallback(cfg, logger=None, **kwargs):
    ...
    metric_monitor = {
        ...
        "loss_recons_feat": "recons_feature/train",
        "loss_recons_trans": "recons_feature_trans/train",
        "loss_commit_feat": "vq_commit/train",
        "loss_commit_trans": "vq_commit_trans/train",
        ...
        "PredValid": "Metrics/pred_valid",
        "CodeFrequency": "Metrics/code_frequency",
        # "FID_new": "Metrics/FID_",
        # "Diversity_new": "Metrics/Diversity_",
    }
    callbacks.append(
