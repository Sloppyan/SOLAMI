other2text_instructions = {
    ...
    "motion": [
        "Describe the motion using plain English.",
        "Describe the motion in plain English.",
        "What kind of motion is displayed? Describe it in text.",
        "Describe the motion portrayed using words.",
        "Please describe the movement using words.",
        "Provide a summary of the action using language.",
        "Describe the action using language.",
        "Give me a brief summary of the motion.",
        "What motion is being demonstrated? Please describe it in text.",
        "Describe the movement using language.",
        "What does the motion communicate? Please describe it in words.",
        "Describe the motion using natural language.",
        "Describe the movement using natural language.",
        "Explain the motion using natural language.",
        "Please explain the action using words.",
        "Describe the action using text.",
        "What kind of movement is being represented?",
        "Describe the movement in plain English.",
        "What kind of motion is shown? Explain it in plain English.",
        "Describe the motion using natural language.",
        "What is happening in the motion? Describe it using text.",
        "Please provide a text-based explanation of the motion.",
        "What does the motion represent? Please describe it in text.",
        "What does the motion demonstrate? Please describe it using text.",
        "Please explain the motion using language.",
        "Please describe the movement using text.",
        "Provide a text-based explanation of the movement demonstrated.",
        "Describe the motion in natural language.",
        "Describe the movement using words.",
        "Provide a summary of the motion using words.",
        "What kind of motion is being illustrated? Explain it using natural language.",
        "Provide a text-based explanation of the action being shown.",
        "What does the action depict? Describe it in language.",
        "What does the motion show? Please explain it using language.",
        "Please provide a description of the movement in words.",
        "Describe the motion in plain English.",
        "What kind of action is being represented? Explain it in text.",
        "Can you tell me what is happening about the motion using natural language?",
        "Provide a textual description of the behavior.",
        "Give me a summary of the movement using words.",
        "Describe the action using plain English.",
        "Explain what the motion is showing using language.",
        "Provide a text-based explanation of the action.",
        "What is being shown in this motion? Please explain it using words.",
        "Describe the movement in plain English.",
        "Describe the motion using natural language.",
        "What does the motion signify? Please explain it using words.",
        "Provide a description of the motion using plain English.",
        "What kind of action is being shown? Explain it in natural language.",
        "Describe the motion in language",
        "Describe the action using natural language.",
        "What kind of motion is shown? Describe it using language.",
        "What does the motion display? Please describe it in language.",
        "Please explain the movement being represented by <Motion_Placeholder> using text.",
        "Can you explain what is happening in the movements using text?",
        "What kind of action is? Please describe it in text.",
        "What kind of action is portrayed? Explain it in text.",
        "Describe the motion displayed in natural language.",
        "Give me a brief summary of the action.",
        "Describe the action being shown using plain English.",
        "What is being depicted in the motion? Please describe it in language.",
        "What does the motion demonstrate? Please explain it in plain English.",
        "Please provide a text-based explanation of the action.",
        "Can you tell me what is happening in the motion using plain English?",
        "Describe the action depicted in the motion using natural language.",
        "What is happening in the motion? Please describe it using text.",
        "What does the <Motion_Placeholder> convey? Please describe it using text.",
        "Can you tell me what is happening in the motion using plain language?",
        "What kind of motion is shown? Explain it in text.",
        "Describe the movement using language.",
        "Describe the motion using words.",
        "Provide a summary of the movement using language.",
        "Provide a textual explanation of the motion.",
        "What does the motion signify? Please explain it in text.",
        "Can you explain the action in the motion using words?",
        "Generate a sentence that explains the action.",
        "Explain the motion using natural language.",
        "Describe the motion using language.",
        "What kind of action is? Explain it in text.",
        "Please explain the movement using text.",
        "Give me a summary of the movement using words.",
        "Explain what the motion is demonstrating using language.",
        "Explain the action using language.",
        "What is being shown in the motion? Please describe it using language.",
        "What is being shown in the motion? Please explain it in natural language.",
        "Please provide a description of the action.",
        "Generate text for <Motion_Placeholder>:",
        "Please provide a description of the motion using words.",
        "Give me a brief summary of the movement.",
        "Please provide a description of the motion using natural language.",
        "Explain the movement using language.",
        "Describe the action using words.",
        "What kind of motion is ? Describe it in words.",
        "What kind of movement is ? Explain it in text.",
    ]
}
